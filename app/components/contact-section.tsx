    ...
    >
      ...
      <div className="flex flex-col gap-7 mt-16">
        ...
        <div className="flex gap-10">
          <input
            className="text-grey-400 bg-grey-500 rounded-[28px] h-10  w-[50%] px-5"
        ...
        <textarea
          className="text-grey-400 bg-grey-500 border-0 rounded-[28px] h-24 w-full p-5"
          placeholder="Type in Your message..."
        />
        <button className="bg-primary text-white w-full h-10 rounded-[28px]">
          SEND
        </button>
      </div>
    </div>
